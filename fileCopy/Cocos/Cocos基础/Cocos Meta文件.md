...
![img](../image/Cocos Meta文件/missingscript.png)
...
- 在 **资源管理器** 中可以对资源进行文件名修改、改变目录、删除文件，添加文件等操作，请参考 [资源管理器](https://docs.cocos.com/creator/manual/zh/getting-started/basics/editor-panels/assets.html)。也可以直接从桌面或操作系统的文件管理器中将文件拖入到 **资源管理器** 中。

  ![img](../image/Cocos Meta文件/add.png)

- 还有一种情况是在操作系统的文件管理器中对 assets 目录中的文件进行增、删、改之后切换到编辑器界面，此时可以看到 **资源管理器** 刷新的过程。

  ![img](../image/Cocos Meta文件/refresh.png)
...
![img](../image/Cocos Meta文件/conflict.png)

从提示中可以看到冲突的 uuid 字符串，然后打开操作系统文件管理或代码编辑器，搜索这个 uuid：

![img](../image/Cocos Meta文件/search_uuid.png)
...
![img](../image/Cocos Meta文件/lost.png)
...
![img](../image/Cocos Meta文件/resources.png)
