...
4. 然后设置好节点和屏幕边缘的距离，下图中左边距设为 50px，下边距设为 30px。
   ...
   ![align left bottom](https://docs.cocos.com/creator/manual/zh/ui/widget-align/align-basic.png)
...
![nested nodes](https://docs.cocos.com/creator/manual/zh/ui/widget-align/hierarchy.png)

其中 `parent` 是一个面板，`button` 是一个按钮。我们可以分别为这两个节点添加 Widget 组件，并且分别设置对齐距离。

对于 `parent` 节点来说，对齐 `Canvas` 节点的左上角，距离都是 80px：

![nested outer element](https://docs.cocos.com/creator/manual/zh/ui/widget-align/nested-outer.png)

对于 `button` 节点来说，对齐 `parent` 节点的左上角，距离都是 50px：

![nested inner element](https://docs.cocos.com/creator/manual/zh/ui/widget-align/nested-inner.png)
...
![stretch](https://docs.cocos.com/creator/manual/zh/ui/widget-align/stretch.png)
...
![full screen node](https://docs.cocos.com/creator/manual/zh/ui/widget-align/full-screen.png)
...
![percentage](https://docs.cocos.com/creator/manual/zh/ui/widget-align/percentage.png)
