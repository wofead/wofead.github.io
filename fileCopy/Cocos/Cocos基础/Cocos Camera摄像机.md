...
![img](https://docs.cocos.com/creator/manual/zh/render/camera/camera.png)
...
- **cullingMask**
  ...
  ![camera-1](https://docs.cocos.com/creator/manual/zh/render/camera/camera-1.png)

  用户可以通过编辑器菜单栏中的 **项目 -> 项目设置 -> 分组管理** 来添加或者更改分组，这些分组即是对应的 mask。

  ![culling mask](https://docs.cocos.com/creator/manual/zh/render/camera/mask-setting.png)

- **clearFlags**

  指定渲染摄像机时需要做的清除操作。

  ![camera-2](https://docs.cocos.com/creator/manual/zh/render/camera/camera-2.png)

- **rect**

  决定摄像机绘制在屏幕上的哪个区域，便于实现类似小地图那样的 Viewport，值为 0～1。

  ![camera-2](https://docs.cocos.com/creator/manual/zh/render/camera/camera-rect.png)
...
这些属性在摄像机节点设置为 [3D 节点](https://docs.cocos.com/creator/manual/zh/3d/3d-node.html) 后才会显示在 **属性检查器** 中。
